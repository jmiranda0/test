        ...
        <div className ="flex min-h-screen items-center justify-center ">
            <div className ="mx-auto max-w-6xl px-6">
                ...
                <div className ="group relative h-96 w-[30rem] cursor-pointer overflow-hidden shadow-lg shadow-black/30 transition-all duration-200">
                    <img className ="h-full object-cover transition-all group-hover:rotate-12 group-hover:scale-125" src={props} alt="" />
                ...
                <div className ="group relative h-96 w-16 cursor-pointer overflow-hidden shadow-lg shadow-black/30 transition-all duration-200">
                    <img className ="h-full object-cover transition-all group-hover:rotate-12 group-hover:scale-125" src="#" alt="" />
                    <div className ="invisible absolute inset-0 bg-gradient-to-b from-green-500/20 to-black group-hover:visible">
                    <div className ="absolute inset-x-5 bottom-6">
                        <div className ="flex gap-3 text-white">
                        <svg width="48" height="48" viewBox="0 0 32 32">
...
export const Img = ()=>{
    return(
        <>
        <div className="group relative cursor-pointer overflow-hidden shadow-lg shadow-black/30 transition-all duration-200">
            <img className="object-cover transition-all group-hover:rotate-12 group-hover:scale-150" src="#" alt="" />
            <div className="absolute inset-x-5 bottom-6">    
